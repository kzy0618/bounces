...
public class AnimationViewer extends JPanel implements ActionListener {
	...
	public AnimationViewer() {
		...
		_shapes.add(new RectangleShape(100, 100, 2, 2, 50, 50));
/*		_shapes.add(new OvalShape(5,10,20,15));
		_shapes.add(new GemShape(0,0,15,20,30,50));
		_shapes.add(new GemShape(56,16,9,18,50,50));
		_shapes.add(new DynamicRectangleShape(0,0,1,1,50,50,Color.RED));	
		_shapes.add(new BorderShape(103,100,1,2,150,150,new DynamicRectangleShape(200,200,2,3,Color.BLUE)));
*/		
		NestingShape _topLevelNest = new NestingShape(0, 0, 2, 2, 100, 100);
		NestingShape _midLevelNest = new NestingShape(0, 0, 3, 4, 50, 50);
		NestingShape _bottomLevelNest = new NestingShape(5, 5, 3, 3, 20, 20);
		Shape _simpleShape = new RectangleShape(6, 6, 1, 1, 5, 5);
		NestingShape _miniLevelNest = new NestingShape(6, 6, 1, 5, 5, 5);
		
		_midLevelNest.add(_bottomLevelNest);
		_midLevelNest.add(_simpleShape);
		_topLevelNest.add(_midLevelNest);
		_midLevelNest.add(_miniLevelNest);
